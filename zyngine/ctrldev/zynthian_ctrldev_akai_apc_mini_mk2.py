...
BTN_TRACK_3 = BTN_LEFT               = 0x6A
BTN_TRACK_4 = BTN_RIGHT              = 0x6B
BTN_TRACK_5 = BTN_KNOB_CTRL_VOLUME   = 0x64
BTN_TRACK_6 = BTN_KNOB_CTRL_PAN      = 0x65
BTN_TRACK_7 = BTN_KNOB_CTRL_SEND     = 0x66
BTN_TRACK_8 = BTN_KNOB_CTRL_DEVICE   = 0x67

BTN_SOFT_KEY_START                   = 0x70
BTN_SOFT_KEY_END                     = 0x74
BTN_SOFT_KEY_CLIP_STOP = BTN_KNOB_1  = 0x70
BTN_SOFT_KEY_SOLO = BTN_KNOB_2       = 0x71
BTN_SOFT_KEY_MUTE = BTN_KNOB_3       = 0x72
BTN_SOFT_KEY_REC_ARM = BTN_KNOB_4    = 0x73
...
# --------------------------------------------------------------------------
class zynthian_ctrldev_akai_apc_mini_mk2(zynthian_ctrldev_zynmixer, zynthian_ctrldev_zynpad):

    dev_ids = ["APC mini mk2 1", "APC mini mk2 2"]
...
class PadMatrixHandler(ModeHandlerBase):
    ...
    # https://github.com/oscaracena/mdevtk/blob/main/examples/apc_mini_mk2/09-pad-tool.py
    GROUP_COLORS = [
